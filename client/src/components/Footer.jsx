        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/recruitment-tools" className="text-gray-400 hover:text-white transition-colors">
                  Recruitment Tools
                </Link>
              </li>
              <li>
                <Link to="/candidate-search" className="text-gray-400 hover:text-white transition-colors">
                  Search Candidates
                </Link>
              </li>
              <li>
          ...
          {/* Company & Support */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">Company & Support</h3>
            <ul className="space-y-2 text-sm">
              <li>
          ...
          <div className="max-w-md">
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-l-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              />
              <button className="px-6 py-2 bg-indigo-600 text-white rounded-r-md hover:bg-indigo-700 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500">
                Subscribe
              </button>
            </div>
          </div>
